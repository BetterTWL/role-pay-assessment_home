// Consolidation of all parsed roles from Excel files
window.JOBS_DATA = [
  {
    "job_name": "SMT",
    "raw_job_name": "SMT",
    ...
    "salary_structure": [
      {
        ...
        "salary_mid": "33000",
        "salary_max": "36000",
        "requirements": "協助基礎收發料/看板更新/溫濕度記錄，需完整OJT培訓，設3/6/12月里程碑",
      ...
      },
      {
        ...
        "salary_mid": "36000",
        "salary_max": "40000",
        "requirements": "獨立執行收發料/批號標籤/ERP基本帳務/釘釘掃碼，可獨立跟催",
      ...
      },
      {
        ...
        "salary_mid": "41000",
        "salary_max": "46000",
        "requirements": "熟練收發料全流程/FIFO管理/批號追溯/IQC配合/盤點作業/ERP倉庫模組熟練",
      ...
      },
      {
        ...
        "salary_mid": "46000",
        "salary_max": "52000",
        "requirements": "KPI管理/呆料分析/特採管理/出貨核對全流程/IATF稽核配合",
      ...
      },
      {
        ...
        "salary_mid": "53000",
        "salary_max": "60000",
        "requirements": "戰略倉管認知/庫存優化/可指導WH4層級/改善提案有實績",
      ...
      },
      {
        ...
        "salary_mid": "62000",
        "salary_max": "70000",
        "requirements": "3-5人倉庫組領導，KPI全面達標，建立SOP/技能矩陣/OJT計畫",
      ...
      },
      {
        ...
        "salary_mid": "70000",
        "salary_max": "80000",
        "requirements": "倉庫策略制定，IATF稽核代表，跨部門協調決策，阿米巴成本管理",
      ...
      },
      {
        ...
        "salary_mid": "77000",
        "salary_max": "88000",
        "requirements": "全廠物流策略，BSC績效管理，倉庫數位化推動，KPI系統建立",
      ...
      },
      {
        ...
        "salary_mid": "90000",
        "salary_max": "105000",
        "requirements": "全公司倉儲物流策略/供應鏈整合/倉庫系統數位轉型主導/董事會報告",
